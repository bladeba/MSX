;*** DI DIR with LFN v0.11
;


;

; Ensambled with sjASM v0.42c
; http://www.xl2s.tk/
;
...
all_string:	db	"*.*",0	
HlpMes:
	db	"DI.COM v0.11 by Victor Martinez",CR,LF
	db	"DIR that shows Long File Name",CR,LF
	db	"Only for Nextor by Konamiman",CR,LF,CR,LF


	db	"Usage:",CR,LF
	db	"DI [Drive:][path][filename]   [/option]",CR,LF,CR,LF
	db	"Options:",CR,LF
...
Directory_TXT:
	db	" Directory of ","$"
t_sistema_invalido
	db	CR,LF,"Only compatbile with FAT12 y FAT16!!",CR,LF,"$"
...
atributos_a_mostrar:	db	010001b;por defecto con subdirectorios y read only
